<div class="max-w-[1440px] mx-auto px-5 lg:px-10 py-4 relative z-10">
    <div class="grid lg:grid-cols-[1fr_400px] gap-4">
        <div class="relative overflow-hidden border border-white/10">
            @if ($people->isEmpty())
                <div class="relative z-10 h-full flex flex-col items-center justify-center text-center px-6 py-16">
                    ...
                    <p class="text-zinc-500 mt-4 max-w-md mx-auto leading-relaxed">Crie grupos, adicione pessoas e comece a construir seu mapa social dentro do Mind.</p>
                    <button type="button" x-on:click="$dispatch('open-modal', 'person-modal')" class="mt-8 px-6 py-3 bg-white text-black font-semibold text-sm hover:scale-[1.02] transition">
        ...
        <div class="space-y-4">
            <div class="h-[480px] border border-white/10 bg-white/[0.015] p-4 overflow-y-auto">
                <template x-if="!selectedPerson">
                    <div class="h-full flex flex-col items-center justify-center text-center opacity-80 mt-10">
                        ...
                        <p class="mt-3 text-sm text-zinc-500 max-w-[220px] leading-relaxed">Gire a esfera e clique em um nó para visualizar ou editar os detalhes da pessoa.</p>
                        ...
                        <div class="mt-8 grid grid-cols-2 gap-3 w-full px-4">
                            ...
                            @php $largestGroup = $groups->sortByDesc('people_count')->first(); @endphp
